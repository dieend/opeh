...
Area::Area(int tipe)
	...
	if(tipe == TOKO) {
		...
		G(3,0,9);G(3,1,2);G(3,2,2);G(3,3,2);G(3,4,2);G(3,5,2);G(3,6,3);G(3,7,9);G(3,8,9);G(3,9,9);
		G(4,0,9);G(4,1,2);G(4,2,2);G(4,3,2);G(4,4,9);G(4,5,9);G(4,6,3);G(4,7,9);G(4,8,9);G(4,9,9);
		G(5,0,9);G(5,1,2);G(5,2,2);G(5,3,9);G(5,4,9);G(5,5,9);G(5,6,3);G(5,7,9);G(5,8,9);G(5,9,9);
		...
		G(9,0,9);G(9,1,9);G(9,2,9);G(9,3,9);G(9,4,9);G(9,5,9);G(9,6,9);G(9,7,9);G(9,8,9);G(9,9,9);
	} else {
		for (int i=0;i<3; i++) {
			for (int j=0; j<10; j++) {
				Point P(i,j);
