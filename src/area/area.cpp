...
Area::Area(int tipe)
	...
	if (tipe == RUMAH) {
		...
		G(4,0,2);G(4,1,2);G(4,2,2);G(4,3,9);G(4,4,9);G(4,5,2);G(4,6,9);G(4,7,2);G(4,8,2);G(4,9,9);
		G(5,0,2);G(5,1,2);G(5,2,2);G(5,3,2);G(5,4,2);G(5,5,9);G(5,6,2);G(5,7,2);G(5,8,2);G(5,9,2);
