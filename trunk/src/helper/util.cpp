...
void Utilities::printPeta(ostream& c)
{
	...
	c << char(186)<<"                                                                       "<< char(186) << endl;	
	c << char(186)<<"                                                                       "<< char(186) << endl;
	c << char(186)<<"                                                      " << char (201);for (int i = 1; i <= 9 ; i++) {c<< char(205);}c <<char (187) << "      "<< char(186) << endl;
	c << char(186)<<"                                                      " << char (186) << "    "<< char(148) <<"    " << char (186) <<"      "<< char(186) << endl;
	c << char(186)<<"                                                      " << char (204);for (int i = 1; i <= 9 ; i++) {c<< char(205);}c <<char (185) <<"      "<< char(186) << endl;
	c << char(186)<<"                                                      " << char (186) << "         " << char (186) <<"      "<< char(186) << endl;
	c << char(186)<<"                                                      " << char (186) << "         " << char (186) <<"      "<< char(186) << endl;
	c << char(186)<<"                                                      " << char (186) << "         " << char (186) <<"      "<< char(186) << endl;
	c << char(186)<<"                                                      " << char (200);for (int i = 1; i <= 9 ; i++) {c<< char(205);}c << char (188) <<"      "<< char(186) << endl;
	c << char(186)<<"                                                                       "<< char(186) << endl;
	c << char(186)<<"                                                                       "<< char(186) << endl;
	c << char(186)<<"                                                                       "<< char(186) << endl;
	c << char(186)<<"                                                                       "<< char(186) << endl;
