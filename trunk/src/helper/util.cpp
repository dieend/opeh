...
void Utilities::printRumah(ostream& c) {
	...
	c << char(186)<<"     "; setBG(LAQUA); setFG(LBLUE); c <<char (186) <<"  ";setFG(WHITE);setBG(WHITE); c << char (218); for (int i = 1; i <= 11; i++) {c << char (196);} c << char (191); resetBG();c  << "  ";resetFG(); c  << char (186); resetFG();resetBG();setBG(YELLOW); c << " " ; setFG(BLACK); c << char (186); setBG(LGREEN); c << "  " ; setFG(LRED); c << char (214); for (int i = 1; i <= 3; i++) {c << char (196);} c << char (191) ; resetFG(); c << " "; resetBG(); c << char (186) ; resetFG(); c << "|     |     " << char (186) << "     |     |     " << char (186); resetBG();c <<"     "<< char(186) << endl;
	c << char(186)<<"     "; setBG(LAQUA); setFG(LBLUE); c <<char (186) <<"  ";setFG(WHITE);setBG(WHITE); c << char (179) << "           " << char (179) ;resetBG();c << "  ";resetFG(); c  << char (186); resetFG();resetBG();setBG(YELLOW); c << " " ; setFG(BLACK); c << char (186); setBG(LGREEN); c << "  " ; setFG(LRED); c << char (186) ; setBG(WHITE); c << "xxx" ; resetBG(); c << char (179) ; resetFG(); c << " "; resetBG(); c << char (186) ; resetFG(); c << "|     |     " << char (186) << "     |     |     " << char (186); resetBG();c <<"     "<< char(186) << endl;
	c << char(186)<<"     "; setBG(LAQUA); setFG(LBLUE); c <<char (186) <<"  ";setFG(WHITE);setBG(WHITE); c << char (192); for (int i = 1; i <= 11; i++) {c << char (196);} c << char (217); resetBG();c << "  ";resetFG(); c  << char (186); resetFG();resetBG();setBG(YELLOW); c << " "; setFG(BLACK); c << char (186); setBG(LGREEN); c << "  " ; setFG(LRED); c << char (211); for (int i = 1; i <= 3; i++) {c << char (196);} c << char (217); resetFG();c << " "; resetBG();c << char (186); resetFG(); c << "|     |     " << char (186) << "     |     |     " << char (186); resetBG();c <<"     "<< char(186) << endl;
	c << char(186)<<"     "; setBG(LAQUA); setFG(LBLUE); c <<char (186) <<"                 " << char (186); resetFG();resetBG();setBG(YELLOW); c << " "; setFG(BLACK); c << char (182);setBG(LGREEN) ; for (int i = 1; i <= 8; i++) {c << char (196);} resetBG(); c << char (182); resetFG(); c << "-------------------------------"; resetBG();c <<"     "<< char(186) << endl; 
	...
	c << char(186)<<"     "; setBG(LPURPLE); setFG(LBLUE); c <<char (186); setFG(RED); c  <<"\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\"; resetFG(); c << char (186); resetFG();resetBG();setBG(YELLOW); c << "       / \\      /             \\      / \\  "; resetBG();c <<"     "<< char(186) << endl;
	c << char(186)<<"     "; setBG(LPURPLE); setFG(LBLUE); c <<char (186); setFG(RED); c  <<"/////////////////"; resetFG(); c << char (186); resetFG();resetBG();setBG(YELLOW); c << "      |   |    /               \\    |   | "; resetBG();c <<"     "<< char(186) << endl;
	c << char(186)<<"     "; setBG(LPURPLE); setFG(LBLUE); c <<char (186); setFG(RED); c  <<"\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\"; resetFG(); c << char (186); resetFG();resetBG();setBG(YELLOW); c << "       \\_/    /                 \\    \\_/  "; resetBG();c <<"     "<< char(186) << endl;
	...
	c << char(186)<<"     "; setBG(YELLOW); c <<"|     |     |     |           |                       |      "; resetBG();c <<"     "<< char(186) << endl;
	c << char(186)<<"     "; setBG(YELLOW); c <<"|     |     |     |            \\                     /       "; resetBG();c <<"     "<< char(186) << endl;
	c << char(186)<<"     "; setBG(YELLOW); c <<"------------------|-----   _    \\                   /    _   "; resetBG();c <<"     "<< char(186) << endl;
	c << char(186)<<"     "; setBG(YELLOW); c <<"|     |     |     |       / \\    \\                 /    / \\  "; resetBG();c <<"     "<< char(186) << endl;
	c << char(186)<<"     "; setBG(YELLOW); c <<"|     |     |     |      |   |    \\               /    |   | "; resetBG();c <<"     "<< char(186) << endl;
	c << char(186)<<"     "; setBG(YELLOW); c <<"|     |     |     |       \\_/      \\_____________/      \\_/  "; resetBG();c <<"     "<< char(186) << endl;
	c << char(186)<<"     "; setBG(YELLOW); c <<"------------------------                                     "; resetBG();c <<"     "<< char(186) << endl;
	c << char(186)<<"     "; setBG(YELLOW); c <<"|     |     |     |     |     |     |     |     |     |     |"; resetBG();c <<"     "<< char(186) << endl;
	c << char(186)<<"     "; setBG(YELLOW); c <<"|     |     |     |     |     |     |     |     |     |     |"; resetBG();c <<"     "<< char(186) << endl;
	c << char(186)<<"     "; setBG(YELLOW); c <<"|     |     |     |     |     |     |     |     |     |     |"; resetBG();c <<"     "<< char(186) << endl;
