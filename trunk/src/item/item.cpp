...
Item* Item::makeBuah(const Grid_Plant* GP){
    Item* item = new Item();
    if (GP->getTypeTanaman() == 1)	{item->setIDitem(12);item->setTypeTanaman(1);item->setTypeBuah(13);item->setEfekBuah(0);item->setEfekTime(0);item->setCostBuy(150);item->setCostSell(720);item->setCostSellBibit(75);item->setBibit(false);item->setNama("kentang");}
    ...
    else if(GP->getTypeTanaman() == 3)	{item->setIDitem(14);item->setTypeTanaman(3);item->setTypeBuah(15);item->setEfekBuah(0);item->setEfekTime(0);item->setCostBuy(200);item->setCostSell(900);item->setCostSellBibit(100);item->setBibit(false);item->setNama("timun");}
    else if(GP->getTypeTanaman() == 4)	{item->setIDitem(15);item->setTypeTanaman(4);item->setTypeBuah(16);item->setEfekBuah(0);item->setEfekTime(0);item->setCostBuy(500);item->setCostSell(2250);item->setCostSellBibit(250);item->setBibit(false);item->setNama("kubis");}
    ...
    else if(GP->getTypeTanaman() == 7)	{item->setIDitem(18);item->setTypeTanaman(7);item->setTypeBuah(19);item->setEfekBuah(0);item->setEfekTime(0);item->setCostBuy(150);item->setCostSell(720);item->setCostSellBibit(75);item->setBibit(false);item->setNama("bawang");}
    else if(GP->getTypeTanaman() == 8)	{item->setIDitem(19);item->setTypeTanaman(8);item->setTypeBuah(20);item->setEfekBuah(0);item->setEfekTime(0);item->setCostBuy(1000);item->setCostSell(4500);item->setCostSellBibit(500);item->setBibit(false);item->setNama("nanas");}
    ...
    else if(GP->getTypeTanaman() == 10)	{item->setIDitem(21);item->setTypeTanaman(10);item->setTypeBuah(22);item->setEfekBuah(0);item->setEfekTime(0);item->setCostBuy(120);item->setCostSell(720);item->setCostSellBibit(60);item->setBibit(false);item->setNama("terong");}
    ...
    else if(GP->getTypeTanaman() == 12)	{item->setIDitem(23);item->setTypeTanaman(12);item->setTypeBuah(24);item->setEfekBuah(0);item->setEfekTime(0);item->setCostBuy(150);item->setCostSell(360);item->setCostSellBibit(75);item->setBibit(false);item->setNama("paprika");}
    return item;
}
