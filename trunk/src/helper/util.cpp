...
void Utilities::printToko(ostream& c) {
	...
	c << char(186)<<"     |";setBG(YELLOW);c<<"                                           "<< char(186);setBG(LBLUE); c <<"            ";resetBG(); c << char(186) <<"  ";resetBG();c<<"|     "<< char(186) << endl;
	c << char(186)<<"      ";setBG(YELLOW);c<<"                                           "<< char(186);setBG(LBLUE); c <<"            ";resetBG(); c << char(186) <<"  ";resetBG();c<<"      "<< char(186) << endl;
	c << char(186)<<"     |";setBG(YELLOW);c<<"       "<<char(201) <<char(205) <<char(187) <<"  "<<char(201)<< char(205) << char(205) << char(205) <<  char(205) << char(205) << char(205) <<  char(205) << char(205) << char(205) <<char(187)<<"  "<<char(201) <<char(205) <<char(187) <<"               "<< char(186);setBG(LBLUE); c <<"    "<<char(17)<<"       ";resetBG(); c << char(186) <<"  ";resetBG();c<<"|     "<< char(186) << endl;
	c << char(186)<<"     |";setBG(YELLOW);c<<"       "<<char(186) <<char(16)  <<char(186)<<"  "<<char(186);setBG(LGREEN); c <<"    |    ";resetBG(); c <<char(186)<<"  "<<char(186) <<char(17)   <<char(186)<<"               "<< char(186);setBG(LBLUE); c <<"            ";resetBG(); c << char(186) <<"  ";resetBG();c<<"|     "<< char(186) << endl;
	c << char(186)<<"     |";setBG(YELLOW);c<<"       "<<char(200) <<char(205) <<char(188) <<"  "<<char(186);setBG(LGREEN); c <<"    |    ";resetBG(); c <<char(186)<<"  "<<char(200) <<char(205) <<char(188) <<"               "<< char(186);setBG(LBLUE); c <<"            ";resetBG(); c << char(186) <<"  ";resetBG();c<<"|     "<< char(186) << endl;
	c << char(186)<<"      ";setBG(YELLOW);c<<"            "<<char(186);setBG(LGREEN); c <<"----O----";resetBG(); c <<char(186)<<"                    "<< char(186);setBG(LBLUE); c <<"            ";resetBG(); c << char(186) <<"  ";resetBG();c<<"      "<< char(186) << endl;
	c << char(186)<<"     |";setBG(YELLOW);c<<"       "<<char(201) <<char(205) <<char(187) <<"  "<<char(186);setBG(LGREEN); c <<"    |    ";resetBG(); c <<char(186)<<"  "<<char(201) <<char(205) <<char(187) <<"               "<< char(186);setBG(LBLUE); c <<"            ";resetBG(); c << char(186) <<"  ";resetBG();c<<"|     "<< char(186) << endl;
	c << char(186)<<"     |";setBG(YELLOW);c<<"       "<<char(186) <<char(16)  <<char(186)<<"  "<<char(186);setBG(LGREEN); c <<"    |    ";resetBG(); c <<char(186)<<"  "<<char(186) <<char(17)   <<char(186)<<"               "<< char(186);setBG(LBLUE); c <<"            ";resetBG(); c << char(186) <<"  ";resetBG();c<<"|     "<< char(186) << endl;
	c << char(186)<<"     |";setBG(YELLOW);c<<"       "<<char(200) <<char(205) <<char(188) <<"  "<<char(200)<< char(205) << char(205) << char(205) <<  char(205) << char(205) << char(205) <<  char(205) << char(205) << char(205) <<char(188)<<"  "<<char(200) <<char(205) <<char(188) <<"               "<< char(186);setBG(LBLUE); c <<"    "<<char(17)<<"       ";resetBG(); c << char(186) <<"  ";resetBG();c<<"|     "<< char(186) << endl;
	c << char(186)<<"      ";setBG(YELLOW);c<<"                                           "<< char(186);setBG(LBLUE); c <<"            ";resetBG(); c << char(186) <<"  ";resetBG();c<<"      "<< char(186) << endl;
	c << char(186)<<"     |";setBG(YELLOW);c<<"                                           "<< char(186);setBG(LBLUE); c <<"            ";resetBG(); c << char(186) <<"  ";resetBG();c<<"|     "<< char(186) << endl;
	c << char(186)<<"     |";setBG(YELLOW);c<<"                                           "<< char(186);setBG(LBLUE); c <<"            ";resetBG(); c << char(186) <<"  ";resetBG();c<<"|     "<< char(186) << endl;
	c << char(186)<<"     |";setBG(YELLOW);c<<"                                           "<< char(186);setBG(LBLUE); c <<"            ";resetBG(); c << char(186) <<"  ";resetBG();c<<"|     "<< char(186) << endl;
	c << char(186)<<"      ";setBG(YELLOW);c<<"                                           "<< char(186);setBG(LBLUE); c <<"            ";resetBG(); c << char(186) <<"  ";resetBG();c<<"      "<< char(186) << endl;
	c << char(186)<<"     |";setBG(YELLOW);c<<"       "<<char(201) <<char(205) <<char(187) <<"  "<<char(201)<< char(205) << char(205) << char(205) <<  char(205) << char(205) << char(205) <<  char(205) << char(205) << char(205) <<char(187)<<"  "<<char(201) <<char(205) <<char(187) <<"               "<< char(186);setBG(LBLUE); c <<"    "<<char(17)<<"       ";resetBG(); c << char(186) <<"  ";resetBG();c<<"|     "<< char(186) << endl;
	c << char(186)<<"     |";setBG(YELLOW);c<<"       "<<char(186) <<char(16)  <<char(186)<<"  "<<char(186);setBG(LBLUE); c <<"    |    ";resetBG(); c <<char(186)<<"  "<<char(186) <<char(17)   <<char(186)<<"               "<< char(186);setBG(LBLUE); c <<"            ";resetBG(); c << char(186) <<"  ";resetBG();c<<"|     "<< char(186) << endl;
	c << char(186)<<"     |";setBG(YELLOW);c<<"       "<<char(200) <<char(205) <<char(188) <<"  "<<char(186);setBG(LBLUE); c <<"    |    ";resetBG(); c <<char(186)<<"  "<<char(200) <<char(205) <<char(188) <<"               "<< char(186);setBG(LBLUE); c <<"            ";resetBG(); c << char(186) <<"  ";resetBG();c<<"|     "<< char(186) << endl;
	c << char(186)<<"      ";setBG(YELLOW);c<<"            "<<char(186);setBG(LBLUE); c <<"----O----";resetBG(); c <<char(186)<<"                    "<< char(186);setBG(LBLUE); c <<"            ";resetBG(); c << char(186) <<"  ";resetBG();c<<"      "<< char(186) << endl;
	c << char(186)<<"     |";setBG(YELLOW);c<<"       "<<char(201) <<char(205) <<char(187) <<"  "<<char(186);setBG(LBLUE); c <<"    |    ";resetBG(); c <<char(186)<<"  "<<char(201) <<char(205) <<char(187) <<"               "<< char(186);setBG(LBLUE); c <<"            ";resetBG(); c << char(186) <<"  ";resetBG();c<<"|     "<< char(186) << endl;
	c << char(186)<<"     |";setBG(YELLOW);c<<"       "<<char(186) <<char(16)  <<char(186)<<"  "<<char(186);setBG(LBLUE); c <<"    |    ";resetBG(); c <<char(186)<<"  "<<char(186) <<char(17)   <<char(186)<<"               "<< char(200)<< char(205)<< char(205)<< char(205)<< char(205)<< char(205)<< char(205)<< char(205)<< char(205)<< char(205)<< char(205)<< char(205)<< char(205) << char(188) <<"  ";resetBG();c<<"|     "<< char(186) << endl;
