...
void Utilities::printRumah(ostream& c) {
	...
	c << char(186)<<"                                                                       "<< char(186) << endl;	
	c << char(186)<<"                                                                       "<< char(186) << endl;
	c << char(186)<<"     "; setBG(YELLOW); setFG(LBLUE); c <<char (201);for(int i = 1; i <= 17; i++) {c << char (205);} c << char (187); resetFG(); c << "------------------------------------------"; resetBG();c <<"     "<< char(186) << endl;
	c << char(186)<<"     "; setBG(YELLOW); setFG(LBLUE); c <<char (186) <<"  ";resetFG();setFG(WHITE); c << char (218); for (int i = 1; i <= 11; i++) {c << char (196);} c << char (191) << "  ";resetFG(); c  << char (186); resetFG(); c << "     |     |     |     |     |     |     |"; resetBG();c <<"     "<< char(186) << endl;
	c << char(186)<<"     "; setBG(YELLOW); setFG(LBLUE); c <<char (186) <<"  ";resetFG();setFG(WHITE); c << char (179) << "           " << char (179) << "  ";resetFG(); c  << char (186); resetFG(); c << "     |     |     |     |     |     |     |"; resetBG();c <<"     "<< char(186) << endl;
	c << char(186)<<"     "; setBG(YELLOW); setFG(LBLUE); c <<char (186) <<"  ";resetFG();setFG(WHITE); c << char (218); for (int i = 1; i <= 11; i++) {c << char (196);} c << char (191) << "  ";resetFG(); c  << char (186); resetFG(); c << "     |     |     |     |     |     |     |"; resetBG();c <<"     "<< char(186) << endl;
